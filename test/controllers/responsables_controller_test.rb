...
class ResponsablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsable" do
    assert_difference('Responsable.count') do
      post responsables_url, params: { responsable: { docente: @responsable.docente, materia: @responsable.materia, nombre: @responsable.nombre } }
    end
  ...
  test "should update responsable" do
    patch responsable_url(@responsable), params: { responsable: { docente: @responsable.docente, materia: @responsable.materia, nombre: @responsable.nombre } }
